...
pitch_m <- bf(Pitch_IQR_s ~ 0 + Diagnosis + (1|ID)) # Han skriver 1 + 
...
pp_check(pitch_skeptic_m2, nsamples = 100)

#evaluate 
#check if we learn something
summary(pitch_skeptic_m2)
plot(hypothesis(pitch_skeptic_m2, "DiagnosisTD < 0"))
hypothesis(pitch_skeptic_m2, "DiagnosisTD < 0")

saveRDS(pitch_skeptic_m2, file = "models/pitch_skeptic_m2.rds")
...
pp_check(pitch_informed_m1, nsamples = 100)

pitch_informed_m2 <- brm(
  pitch_m,
  data = d,
  family = gaussian(),
  prior = informed_prior,
...
pp_check(pitch_informed_m2, nsamples = 100)
#evaluate 
#check if we learn something
summary(pitch_skeptic_m2)
...
``` {r Part 5, echo=FALSE}
plot(hypothesis(pitch_informed_m2, "DiagnosisTD < 0"))
plot(hypothesis(pitch_skeptic_m2, "DiagnosisTD < 0"))

loo_model_weights(pitch_skeptic_m2, pitch_informed_m2)
```
